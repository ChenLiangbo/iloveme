...
for d in yahooData:
    ...
    sheet1.write(i,0,float(d['Adj_Close']))
    sheet1.write(i,1,float(d['High']))
    sheet1.write(i,2,float(d['Low']))
    sheet1.write(i,3,float(d['Close']))
    sheet1.write(i,4,float(d['Open']))
    sheet1.write(i,5,d['Date'])
    sheet1.write(i,6,d['Volume'])
    sheet1.write(i,7,d['Symbol'])
    i = i + 1
