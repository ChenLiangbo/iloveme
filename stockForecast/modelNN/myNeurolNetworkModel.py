...
class MyNeurolNetworkModel(object):
    ...
    def __init__(self,):
        ...
        self.parameterPath = self.outdir + 'parameter.txt'
...
if __name__ == '__main__':
    ...
    # myNNmodel.isTrian = True
    # myNNmodel = MyNeurolNetworkModel()
    # myNNmodel.errorRate = 0.045
    # myNNmodel.train_predict(x_train,y_train)
