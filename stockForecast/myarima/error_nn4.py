...
y_train_predict = np.load('./npyfile/nn4_y_train_predict.npy')
...
plt.grid(True)
plt.savefig('./ploter/nn4_y_train_denormalized.jpg')
plt.show()
...
plt.grid(True)
plt.savefig('./ploter/nn4_y_test_denormalized.jpg')
plt.show()
'''
...
plt.grid(True)
plt.savefig('./ploter/nn4_train_acurracy.jpg')
plt.show()
...
plt.grid(True)
plt.savefig('./ploter/nn4_test_acurracy.jpg')
plt.show()
